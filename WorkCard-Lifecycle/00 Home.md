...
**Этап 4 скорректирован:** UX-документы и отдельный [14-шаговый кликабельный прототип](docs/ux/prototype.html) включают `RecordFinalBatchAcceptance` и read-back отдельной записи партии. Этап 5 не начат и остаётся следующей контрольной точкой после review.
