...
| 2 | Доменная спецификация | `[ ]` не начато | Бизнес-логика описана до кода |
...
## Этап 2. Доменная спецификация

- [ ] [[glossary]]
- [ ] [[as-is-to-be|AS-IS и TO-BE]]
- [ ] [[domain-model|Сущности, связи и агрегаты]]
- [ ] [[business-rules|Бизнес-инварианты]]
- [ ] [[commands-events|Команды и доменные события]]
- [ ] [[work-card-state-machine|State machine WorkCard]]
