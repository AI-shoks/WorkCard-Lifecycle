...
| Финальная приёмка всей партии и подписи БТК | `ASIS-010`, `ASIS-011` | `D-020` | `BR-036` | `UC-007` — существующий read/provenance UC; digital acceptance-команда вне MVP | `US-018` | `AC-READ-002` | `T-E2E-PROVENANCE-001` |
...
| Audit каждой успешной команды | `N/A` — техническое свойство TO-BE | `D-011` | `BR-050`–`BR-053` | `UC-008`, `UC-014` | `US-009`, `US-017`, `US-020` | `AC-AUD-001`–`AC-AUD-004` | `T-API-AUDIT-001`–`004`, `T-E2E-AUDIT-001` |
...
| Optimistic concurrency | `N/A` — техническое свойство TO-BE | `D-011` | `BR-002`, `BR-060`–`BR-062` | `UC-002`–`UC-006`, `UC-009`, `UC-012` | `US-012`, `US-015`, `US-019` | `AC-CON-001`, `AC-CON-002`, `AC-TXN-001` | `T-API-CONCURRENCY-001`–`003`, `T-E2E-CONFLICT-001` |
| Trusted permissions | `ASIS-006`, `ASIS-007` | `D-012`, `D-016`, `D-017` | `BR-001` | `UC-001`–`UC-006`, `UC-008`, `UC-009` | `US-001`–`US-012` | `AC-AUT-001`–`AC-AUT-003` | `T-API-PERMISSION-001`–`006` |
...
| `BR-030`–`BR-036` | `AC-LIF-001`–`005`, `AC-AUT-002`, `AC-READ-002`; `NS-010`–`NS-018` |
...
| Финальная приёмка всей партии и подписи БТК | `ASIS-010`, `ASIS-011` | `D-020` | `BR-036` | `UC-007` — provenance существующего read UC | `US-018` | `AC-READ-002` | `T-E2E-PROVENANCE-001` |
